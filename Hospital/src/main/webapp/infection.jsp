...
<body>
	<p></p>
	<div class="card bg-success mx-auto text-white card-custom">
		<div class="card-body">
			<h1>ENTER INFECTION</h1>
			<form action="patientcontrollerservlet" method="post" class="row">
			<div class="col-md-6">
					<div class="input-group flex-nowrap input-jp">
						<span class="input-group-text">Transmitter</span> <input type="number"
							class="form-control" placeholder="Transmitter document" aria-label="transmitter"
							aria-describedby="addon-wrapping" id="transmitter" name="transmitter">
					</div>
				</div>
				<div class="col-md-6">
					<div class="input-group flex-nowrap input-jp ">
						<span class="input-group-text">Infected</span> <input type="number"
							class="form-control" placeholder="Infected document" aria-label="infected"
							aria-describedby="addon-wrapping" id="infected" name="infected">
					</div>
				</div>
				<input type="hidden" name="method" value="infection">
				<input type="submit" class="btn btn-light button-enter mx-auto"
					value="Confirm">
			</form>
		</div>
	</div>
